...
import { Text, View, TouchableOpacity, Modal, ScrollView } from 'react-native'; // Include ScrollView from 'react-native'
...
const HomeScreen = () => {
  ...
  return (
    <View style={styles.container}>
      <ScrollView
        style={styles.videoScrollView} // Add styles for the ScrollView
